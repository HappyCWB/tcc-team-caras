function [ BoundingBox, plotDaElipse ] = encontrarRetanguloEElipseNoRosto( imagemBWcomPontosNoRosto )

    [w, h]=size(imagemBWcomPontosNoRosto(:,:));
    s = regionprops(imagemBWcomPontosNoRosto,'Centroid','MajorAxisLength','MinorAxisLength','Orientation','PixelList');
